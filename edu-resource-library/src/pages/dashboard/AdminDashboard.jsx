    ...
    },
    {
        ...
        render: (row) => (
            <div className="action-buttons">
                <span className="text-xs text-muted" style={{ fontStyle: 'italic' }}>Manage via Users Tab</span>
            </div>
        )
    }
];
    ...
    return (
        <div className="dashboard-page animate-fade-in">
            ...
            <div className="stats-grid">
                ...
                {/* Optional: Add truly dynamic metrics here later, or leave with these 2 accurate cards */}
            </div>
